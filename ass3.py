...
TrainingImagePath="Image/train"
TestImagePath="Image/test"
ValidationImagePath="Image/valid"
...
# The number of neurons for the output layer is equal to the number offaces
